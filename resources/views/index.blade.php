    ...
    <header id="header" class="header sticky-header fixed-header">
      ...
      <div class="top-header">
        ...
        <div class="logo-wrap">
          ...
          <a href="index.html" class="logo"><img src="dp/images/rlogo.png" alt="" width="150" height="100"></a>
                ...
                <ul id="menu" class="clearfix">
                  ...
                  <li><a href="#">The Church</a>
                    ...
                    <div class="sub-menu-wrap">
                      <ul>
                        <li><a href="about_us.html">History of the Parish</a></li>
                        <li><a href="leadership.html">Our Belief</a></li>
                        <li><a href="team_member.html">About the Pastor</a></li>
                        <li><a href="give_serve.html">Pastoral Team</a></li>
                        <li><a href="https://rccggermany.org/" target="_blank">RCCG Germany</a> </li>
      ...
      <div id="rev-slider" class="rev-slider tp-simpleresponsive"  data-version="5.0">
        ...
        <ul>
          ...
          <li data-transition="fade">
            ...
            <img src="dp/images/1920x980_slide1.jpg" class="rev-slidebg" alt="">
          ...
          <li data-transition="fade">
            ...
            <img src="dp/images/1920x980_slide2.jpg" class="rev-slidebg" alt="">
          ...
          <li data-transition="fade">
            ...
            <img src="dp/images/1920x980_slide3.jpg" class="rev-slidebg" alt="">
        ...
        <div class="container wide">
          ...
          <div class="row row-wide align-items-center">
            ...
            <div class="col-md-6">
              ...
              <h2 class="title2">Welcome to Dominion Parish Bremen!</h2>
        ...
        <div class="icons-wrap">
          ...
          <div class="icons-item">
            <div class="item-box">
              ...
              <p>July- Exercising the Spirit</p>
              <div class="hidden-area">
                <a href="#" class="btn btn-style-3">Read More</a>
              </div>
            </div>
          ...
          <div class="entry-box flex-row item-col-3">
            ...
            <div class="entry-col">
              ...
              <div class="entry">
                ...
                <div class="thumbnail-attachment">
                  <a href="#"><img src="dp/images/430x252_img1.jpg" alt=""></a>
                </div>
            ...
            <div class="entry-col">
              ...
              <div class="entry">
                ...
                <!-- - - - - - - - - - - - - - Entry attachment - - - - - - - - - - - - - - - - -->
                <div class="thumbnail-attachment">
                  <a href="#"><img src="dp/images/430x252_img2.jpg" alt=""></a>
                </div>
            ...
            <div class="entry-col">
              ...
              <div class="entry">
                ...
                <!-- - - - - - - - - - - - - - Entry attachment - - - - - - - - - - - - - - - - -->
                <div class="thumbnail-attachment">
                  <a href="#"><img src="dp/images/430x252_img3.jpg" alt=""></a>
                </div>
